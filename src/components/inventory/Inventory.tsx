    ...
    >
      ...
      <section className="px-6">
        <div className="flex justify-between items-end mb-4">
          <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Kapacita (0 / {SLOTS})</h3>
        </div>
        ...
        <div className="grid grid-cols-4 gap-3">
          {Array.from({ length: SLOTS }).map((_, idx) => (
            <motion.div
              ...
              className="aspect-square rounded-xl bg-slate-900/40 border border-slate-800/60 shadow-inner flex items-center justify-center group relative overflow-hidden"
            >
        ...
        <div className="mt-8 p-4 rounded-2xl bg-slate-900/20 border border-white/5 text-center">
          <p className="text-[10px] font-black text-slate-600 uppercase italic">Zatím se nezdá, že bys měl v batohu něco užitečného.</p>
        </div>
      </section>
    </motion.div>
  );
