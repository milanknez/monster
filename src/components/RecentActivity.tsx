  ...
  return (
    <section className="px-4 py-4">
      <div className="flex justify-between items-center mb-3 px-1">
        <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Nedávná aktivita</h3>
        <button 
          onClick={onSeeAll}
      ...
      <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
        {displayList.map((m, idx) => (
          ...
          >
            <img src={m.image} className="size-full object-contain relative z-10 drop-shadow-[0_0_5px_rgba(255,255,255,0.1)] pointer-events-none" />
