            ...
            <div className="relative mb-8 flex justify-center min-h-[160px] w-full">
              {!isChestOpened ? (
                ...
                >
                  ...
                  <Package size={100} className="text-primary relative z-10" />
                  <p className="mt-4 text-[10px] font-black text-primary animate-pulse uppercase">Klikni k otevření</p>
                </motion.div>
              ) : (
                <div className="grid grid-cols-2 gap-4 w-full">
                  ...
                  {loot.every(l => l.collected) && (
                    <motion.button 
                      ...
                      onClick={onComplete} 
                      className="col-span-2 py-5 mt-6 bg-primary text-black font-black uppercase tracking-widest rounded-2xl flex items-center justify-center gap-2 active:scale-95 transition-all shadow-xl shadow-primary/20"
                    >
