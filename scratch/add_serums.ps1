...
$newItems = '  },
  "xp_serum_1": {
    ...
    "category": "relic",
    "rarity": "Vzácná",
    "description": { "cz": "Genetický stimulant, který okamžitě přidá 200 XP.", "en": "Genetic stimulant that instantly adds 200 XP.", "sk": "Genetický stimulant, ktorý okamžite pridá 200 XP." },
  ...
  "xp_serum_3": {
    ...
    "category": "relic",
    "rarity": "Legendární",
    "description": { "cz": "Maximální genetický stimulant, který okamžitě přidá 700 XP.", "en": "Ultimate genetic stimulant that instantly adds 700 XP.", "sk": "Maximálny genetický stimulant, ktorý okamžite pridá 700 XP." },
    "dropWeight": 1, "dropMin": 1, "dropMax": 1,
    "stats": { "xp": 700 },
    "hasCustomIcon": true, "customIcon": "xp_serum_3"
  }
};'
$content = $content -replace "  }\s*};`r?`n?$", $newItems
